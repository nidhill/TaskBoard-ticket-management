    ...
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      {projects.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-xs text-gray-400 max-w-[200px]">Create a project to start tracking work.</p>
        </div>
      ) : (
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-50">
                <th className="text-left text-[10px] font-semibold text-gray-400 uppercase tracking-[1.2px] py-3 px-6">Project</th>
                <th className="text-left text-[10px] font-semibold text-gray-400 uppercase tracking-[1.2px] py-3 px-4">Client</th>
                <th className="text-left text-[10px] font-semibold text-gray-400 uppercase tracking-[1.2px] py-3 px-4">Status</th>
                <th className="text-left text-[10px] font-semibold text-gray-400 uppercase tracking-[1.2px] py-3 px-4">Progress</th>
                <th className="text-left text-[10px] font-semibold text-gray-400 uppercase tracking-[1.2px] py-3 px-4">Deadline</th>
