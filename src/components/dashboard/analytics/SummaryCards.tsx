            ...
            {items.map((stat, i) => (
                <div key={i} className="bg-card rounded-xl border border-border shadow-sm p-5 hover:shadow-md transition-shadow">
                    ...
                    <div className="flex items-center justify-between mb-5">
                        <span className="text-[10px] font-bold uppercase tracking-[1.6px] text-muted-foreground">
                            {stat.label}
                        </span>
                        <div
                    ...
                    {/* Number */}
                    <div
                        className={stat.urgent ? 'text-red-500' : 'text-foreground'}
                        style={{
                    ...
                    <div className="text-xs text-muted-foreground mt-1.5">{stat.subLabel}</div>
                </div>
            ))}
        </div>
    );
