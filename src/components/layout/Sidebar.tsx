...
export function Sidebar() {
  ...
  const navigation = [
    ...
    { name: 'Projects', href: '/projects', icon: FolderKanban, show: permissions.canViewProjects },
  ...
  return (
    <ShadcnSidebar collapsible="icon">
      ...
      <SidebarContent style={{ padding: '8px 0' }}>
        ...
        {/* Search trigger */}
        {isCollapsed ? (
          <SidebarGroup style={{ padding: '0 0 4px' }}>
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton
          ...
          <div style={{ padding: '0 14px 8px' }}>
            ...
            >
              <Search style={{ width: 13, height: 13, opacity: 0.7, flexShrink: 0 }} />
